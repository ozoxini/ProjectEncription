...
class CtrMethod(BaseCryptoAlgorithm):
    ...
    def _ctr_xor_operation(self, core: AESCore, data: bytes, expanded_key: list[list[int]], iv: bytes) -> bytes:
        """
    ...
    def encrypt(self, data: Union[str, bytes], key: Any, **options) -> Union[str, bytes]:
        ...
        try:
            ...
            encrypted_data = self._ctr_xor_operation(core, data_bytes, expanded_key, iv)
    ...
    def decrypt(self, data: Union[str, bytes], key: Any, **options) -> Union[str, bytes]:
        ...
        try:
            ...
            decrypted_bytes = self._ctr_xor_operation(core, ciphertext, expanded_key, iv)
